---
title: "Visualization of the covid_19 confirmed cases"
...
```{r}
confirmed.cases <- read.csv("D:\\1.DATA SCIENCEMasters\\SemesterII\\4. Advanceddatamining\\Assignments\\3.Assignement_spatial covid\\HAILESELASSIE\\COUNTY DATA.csv", header=TRUE)
confirmed.cases
```
